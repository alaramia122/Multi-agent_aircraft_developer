...
def create_mcp_http_app(
    ...
    *,
    ...
    The public hostname is explicit rather than inferred from the bind address.
    This keeps DNS-rebinding protection enabled for real deployments and makes the
    deployment boundary responsible for the host/origin allowlist. Authentication
    and actor provisioning remain deployment concerns; the supplied actor is the
    Gateway identity used for every call handled by this MCP endpoint.
    """
